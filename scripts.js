...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (trendingContainer && typeof ProductRenderer !== 'undefined') {
        const trRenderer = new ProductRenderer('all', 'trending-products');
...
// Smooth Scroll for generic links (Excluding Virtual IDs and Category Sections)
document.querySelectorAll('a[href^="#"]:not([href^="#cat-"]):not([href^="#details-"]):not([href="#editors-pick-featured"]):not([href="#compare-prices-table"])').forEach(anchor => {
